...
window.STATES = [
  {
    ...
    soundDesc: "Soft descending power-down.",
  ...
  },
  {
    ...
    soundDesc: "Gentle rising arpeggio (D→F#→A) + shimmer.",
  ...
  },
  {
    ...
    soundDesc: "Sparse contemplative blips (loop).",
  ...
  },
  {
    ...
    soundDesc: "Questioning upward “hm?” (E→A↗B).",
  ...
  },
  {
    ...
    soundDesc: "Attentive rising pop (D→A→D).",
